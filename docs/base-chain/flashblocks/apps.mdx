...
See the [JSON-RPC API Reference](/base-chain/reference/json-rpc-api) for the full list of supported RPC methods and WebSocket subscription types, including Flashblocks-specific methods.
...
For a full reference of all supported RPC methods — including preconfirmed state queries, simulation, and real-time subscriptions — see the [JSON-RPC API Reference](/base-chain/reference/json-rpc-api).
